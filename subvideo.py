...
def extract_audio_from_youtube(url):
    ...
    video.streams.get_highest_resolution().download(output_path="./temp", filename=input_video)
...
# url = "https://www.youtube.com/watch?v=QspjKVTMlL8"
# language = 'yo'
# create_subbed_video(url, language)
